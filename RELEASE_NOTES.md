...
- Add missing `mg_` or `MG_` to symbols in civetweb/civetweb.h. Symbols without will be removed a future version.
...
- Win32: Replace dll.def file by export macros in civetweb/civetweb.h (CSTAJ)
...
- Moved CIVETWEB_VERSION define into civetweb/civetweb.h
