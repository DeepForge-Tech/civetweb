...
- [API documentation](https://github.com/civetweb/civetweb/tree/master/docs/api) - Additional documentation on the civetweb application programming interface ([civetweb/civetweb.h](https://github.com/civetweb/civetweb/blob/master/include/civetweb/civetweb.h)).
